...
public class MainClass {
    ...
    public static void gen_keys() {
		...
		SecureRandom sp12 = new SecureRandom();
		for (int i = 0; i < 64; i++) {
			m = sp12.nextInt(2);
			if (m == 0)
				str2.append((char)(97 + (sp12.nextInt(6))));
			if (m == 1)
				str2.append((char)(48 + (sp12.nextInt(10))));
		}
		disp_rec("char *keys[] = {\"");
		disp_rec(str2.toString() + "\"}; // Serpent's key\n");
		disp_rec("uint8_t projection_key[32] = {\n");
		for (int i = 0; i < 8; i++) {
			SecureRandom sk0 = new SecureRandom();
			for (int j = 0; j < 4; j++) {
				m = sk0.nextInt(2);
				m1 = sk0.nextInt(2);
				disp_rec("0x");
				...
				if (m == 0)
					str0.append((char)(97 + (sk0.nextInt(6))));
				if (m == 1)
					str0.append((char)(48 + (sk0.nextInt(10))));
				if (m1 == 0)
					str0.append((char)(97 + (sk0.nextInt(6))));
				if (m1 == 1)
					str0.append((char)(48 + (sk0.nextInt(10))));
				str0.append(",");
				if (i == 7 && j == 3)
					str0.setLength(str0.length() - 1);
				disp_rec(str0.toString());
			}
			disp_rec("\n");
		}
		disp_rec("};\n");
		disp_rec("byte TDESkey[] = {\n");
		for (int i = 0; i < 6; i++) {
			SecureRandom sk1 = new SecureRandom();
			for (int j = 0; j < 4; j++) {
				m = sk1.nextInt(2);
				m1 = sk1.nextInt(2);
				disp_rec("0x");
				...
				if (m == 0)
					str3.append((char)(97 + (sk1.nextInt(6))));
				if (m == 1)
					str3.append((char)(48 + (sk1.nextInt(10))));
				if (m1 == 0)
					str3.append((char)(97 + (sk1.nextInt(6))));
				if (m1 == 1)
					str3.append((char)(48 + (sk1.nextInt(10))));
		...
		for (int i = 0; i < 6; i++) {
			...
			for (int j = 0; j < 4; j++) {
				...
				StringBuilder str3 = new StringBuilder();
				if (m == 0)
					str3.append((char)(97 + (sk2.nextInt(6))));
				if (m == 1)
					str3.append((char)(48 + (sk2.nextInt(10))));
				if (m1 == 0)
					str3.append((char)(97 + (sk2.nextInt(6))));
				if (m1 == 1)
					str3.append((char)(48 + (sk2.nextInt(10))));
	  ...
	  public static void main(String[] args){
	      ...
	      */
		  StringBuilder slt = new StringBuilder();
	        ...
	        JButton genr = new JButton("Generate keys for the Black Swan project");

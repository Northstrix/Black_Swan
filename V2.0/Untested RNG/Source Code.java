...
public class Editor {
    ...
    public static void gen_keys() {
	    ...
	    disp_rec("String prefix = \"");
	    for (int i = 0; i < 6; i++) {
	      SecureRandom sp1 = new SecureRandom();
	        m = sp1.nextInt(3);
	        m1 = sp1.nextInt(2);
	        StringBuilder str01 = new StringBuilder();
	        if (m == 0)
	          str01.append((char)(65 + (sp1.nextInt(26))));
	        if (m == 1)
	          str01.append((char)(97 + (sp1.nextInt(26))));
	        if (m == 2)
	          str01.append((char)(48 + (sp1.nextInt(10))));
	        disp_rec(str01.toString());
	    }
	    disp_rec("\";\n");
		...
		for (int i = 0; i < 2; i++) {
				...
				if (i == 0)
					str22.append((char)(51 + (nofincrem.nextInt(7))));
				else
	  ...
	  public static void main(String[] args){
	      ...
	      */
		  StringBuilder slt = new StringBuilder();
	        ...
	        JButton genr = new JButton("Generate keys for Black Swan V2.0");
